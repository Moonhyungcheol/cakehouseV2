...
public class JoinMenberShip {
    ...
    public UserInfo userJoin() {
        ...
        while (!isValidId(id)) {
            System.out.println("¾ÆÀÌµð Çü½ÄÀÌ Àß¸ø µÇ¾ú½À´Ï´Ù. Ã¹ ±ÛÀÚ´Â ¿µ¹®À¸·Î ½ÃÀÛÇÏ°í 6±ÛÀÚ ÀÌ»ó ÀÔ·ÂÇØÁÖ½Ê½Ã¿À.");
        ...
        while (!isValidPwd(password)) {
            System.out.println("ºñ¹Ð¹øÈ£¿¡ °ø¹éÀ» ³ÖÀ» ¼ö ¾ø°í 8ÀÚ¸® ÀÌ»ó ÀÔ·ÂÇØÁÖ½Ê½Ã¿À.");
    ...
    public UserInfo userLogin(String id, String password) {
        ...
        do {
            System.out.println("[1] ´Ù½Ã ÀÔ·Â [2] ÃÊ±âÈ­¸é");
